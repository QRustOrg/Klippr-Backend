...
namespace Klippr_Backend.Reviews.Infrastructure.Migrations
{
    ...
    [Migration("20260617191402_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Klippr_Backend.Reviews.Domain.Aggregates.Review", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Klippr_Backend.Reviews.Domain.Aggregates.ReviewComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Klippr_Backend.Reviews.Domain.Aggregates.ReviewComment", b =>
                {
                    b.HasOne("Klippr_Backend.Reviews.Domain.Aggregates.Review", null)
                        .WithMany("Comments")
