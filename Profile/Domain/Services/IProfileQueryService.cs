...
public interface IProfileQueryService
{
    ...
    Task<ConsumerProfile?> GetConsumerProfileByIdAsync(GetConsumerProfileByIdQuery query, CancellationToken cancellationToken = default);
    Task<BusinessProfile?> GetBusinessProfileByIdAsync(GetBusinessProfileByIdQuery query, CancellationToken cancellationToken = default);
