...
public interface IRedemptionQueryService
{
    ...
    Task<Redemption?> Handle(GetRedemptionByIdQuery query);
    ...
    Task<IEnumerable<Redemption>> Handle(GetRedemptionsByConsumerIdQuery query);
    ...
    Task<IEnumerable<Redemption>> Handle(GetRedemptionsByBusinessIdQuery query);
}
